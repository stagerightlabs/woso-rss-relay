...
use Relay\Article;
use Relay\Sites\HalifaxTides;

final class Tides implements Parser
{
    /**
    ...
    {
        return 'https://www.tidesfc.ca/news';
    }
    ...
    public function article(Response $response, array $context = []): Article
    {
        ...
        // Slug
        $article->site = HalifaxTides::slug();
        ...
        // Author
        $article->author = 'Halifax Tides FC';
