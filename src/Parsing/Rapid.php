...
use Relay\Article;
use Relay\Sites\OttawaRapid;

final class Rapid implements Parser
{
    /**
    ...
    {
        return 'https://www.rapidfc.ca/news';
    }
    ...
    public function article(Response $response, array $context = []): Article
    {
        ...
        // Author
        $article->author = 'Ottawa Rapid FC';
