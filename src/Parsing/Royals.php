...
use Relay\Article;
use Relay\Sites\UtahRoyals;

final class Royals implements Parser
{
    /**
    ...
    {
        return 'https://www.rsl.com/utahroyals/news/latest/1';
    }
