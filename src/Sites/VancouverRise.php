...
final class VancouverRise implements Site
{
    /**
    ...
    {
        return asset('images/vancouver-rise-crest.svg');
    }
    ...
    {
        return 'https://www.vanrisefc.com/';
    }
